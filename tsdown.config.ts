/**
 * tsdown build for dsh-usage-dashboard:
 ...
 *   profile channel, registered with the package-name id `dsh-usage-dashboard`
 *   through window.__ModuleLoader__.load({ id, factory }).
 *
...
/** Profile channel: bundle id = package.json `name`. */
